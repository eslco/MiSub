  ...
  <div>
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-4 list-item-animation" style="--delay-index: 0">
      <div class="flex items-center gap-3">
        <h2 class="text-xl font-bold text-gray-900 dark:text-white">My Group我的订阅组</h2>
      ...
      <div class="flex items-center gap-2 w-full sm:w-auto justify-end sm:justify-start">
        <button @click="handleAdd" class="text-sm font-semibold px-4 py-1.5 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white transition-colors shadow-xs shrink-0">Add新增</button>
